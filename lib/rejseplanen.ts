...
function buildTripOptions(origin, destination) {
    ...
    Object.assign(
        options,
        origin.id ? buildTripOptionsFromId(origin, 'origin') : buildTripOptionsFromCoordinates(origin, 'origin'),
        destination.id ? buildTripOptionsFromId(destination, 'dest') : buildTripOptionsFromCoordinates(destination, 'dest')
    );
    return options;
}
